...
See <<managing-addons-in-control-center>> for an example adding this same library to your project using the Codename One Control Center.
...
**DO NOT REMOTE THIS COMMENT**.  Just add your dependency snippet somewhere before or after it.
====
